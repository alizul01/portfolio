...
export default function Banner() {
  return (
    <div className="h-28 md:h-44 overflow-hidden rounded-md bg-gray-800 text-black flex justify-center items-center hover:bg-gray-700 transition duration-500 ease-in-out cursor-pointer active:bg-gray-900 flex-col group-active">
